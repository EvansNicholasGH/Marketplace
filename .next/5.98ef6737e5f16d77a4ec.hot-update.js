...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_semantic_ui_react__ = __webpack_require__("./node_modules/semantic-ui-react/dist/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ETH_coinListing__ = __webpack_require__("./ETH/coinListing.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ETH_web3__ = __webpack_require__("./ETH/web3.js");
...
var _jsxFileName = "C:\\Users\\nicholas\\Desktop\\MISC SCHOOL\\E14\\pages\\items\\sell.js";
...
function (_Component) {
  ...
  function ICOnew() {
    ...
    _classCallCheck(this, ICOnew);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = ICOnew.__proto__ || Object.getPrototypeOf(ICOnew)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.prev = 2;
                  _context.next = 5;
                  return __WEBPACK_IMPORTED_MODULE_5__ETH_web3__["a" /* default */].eth.getAccounts();

                case 5:
                  accounts = _context.sent;

                  _this.setState({
                    itemAddress: accounts[0]
                  });

                  user = accounts[0];

                  if (!(_this.state.itemKind === '' || _this.state.itemPrice === '' || _this.state.itemDescription === '')) {
                    _context.next = 10;
                    break;
                  }
                ...
                case 10:
                  _context.next = 12;
                  return __WEBPACK_IMPORTED_MODULE_4__ETH_coinListing__["a" /* default */].methods.listItem(_this.state.itemAddress, _this.state.itemKind, _this.state.itemHash, _this.state.itemIpfs, parseInt(_this.state.itemPrice), _this.state.itemDescription).send({
                    from: accounts[0]
                  });
  ...
  _createClass(ICOnew, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_Layout__["a" /* default */], {
      ...
      }, "Sell an Item"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_semantic_ui_react__["d" /* Form */], {
      ...
      }, "Item Kind"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_semantic_ui_react__["g" /* Input */], {
        placeholder: "Kind",
      ...
      }, "Price"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_semantic_ui_react__["g" /* Input */], {
      ...
      }, "Upload Image"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_semantic_ui_react__["g" /* Input */], {
        placeholder: "type",
        value: this.state.itemIpfs,
        onChange: function onChange(event) {
          return _this2.setState({
            itemHash: event.target.value,
            itemIpfs: event.target.value
          });
        },
        __source: {
          fileName: _jsxFileName,
        ...
        control: __WEBPACK_IMPORTED_MODULE_3_semantic_ui_react__["k" /* TextArea */],
        label: "Description",
      ...
      }), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_semantic_ui_react__["j" /* Message */], {
        error: true,
...
(function () {
  ...
  reactHotLoader.register(ICOnew, "ICOnew", "C:\\Users\\nicholas\\Desktop\\MISC SCHOOL\\E14\\pages\\items\\sell.js");
  reactHotLoader.register(_default, "default", "C:\\Users\\nicholas\\Desktop\\MISC SCHOOL\\E14\\pages\\items\\sell.js");
  leaveModule(module);
})();
...
;
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/items\\sell")
...
//# sourceMappingURL=5.98ef6737e5f16d77a4ec.hot-update.js.map